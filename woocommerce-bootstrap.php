...
{ 
	...
	register_setting('woocommerce-bootstrap-group', 'number_of_columns'); 
	register_setting('woocommerce-bootstrap-group', 'tbversion'); 
	register_setting('woocommerce-bootstrap-group', 'wootb_size'); 
...
{
	 add_options_page('WooCommerce Bootstrap Settings', 'WooCommerce Bootstrap', 'manage_options', 'woocommerce-bootstrap', array(&$this, 'plugin_settings_page'));
...
// END public function plugin_settings_page() 
	...
	<div class="wrap"> 
		...
		<h2>WooCommerce Bootstrap <?php echo __('Settings','wootb');?></h2> 
	
		<form method="post" action="options.php"> 
		<?php settings_fields('woocommerce-bootstrap-group'); ?> 
		...
		<tr valign="top"> 
		<th scope="row">
		<label for="tbversion"><?php echo __('Bootstrap version','wootb');?></label></th> 
		<td>
			<?php
			$tbversion = (get_option('tbversion'))?get_option('tbversion'):3;
			?>
			<input type="radio" value="2" name="tbversion" <?php echo ($tbversion==2)?' checked="checked"':''?>>Bootstrap 2.x (2.3.2)<br>
			<input type="radio" value="3" name="tbversion"<?php echo ($tbversion==3)?' checked="checked"':''?>>Bootstrap 3.x<br>
		</td> 
		</tr> 
...
function bs_get_product_thumbnail(){
    ...
    if(empty($thumbnail)){
    	...
    	if(!file_exists( $template = get_stylesheet_directory() . '/woocommerce-bootstrap/placeholder.php' ))
    	{
...
{ 
$settings_link = '<a href="options-general.php?page=woocommerce-bootstrap">Settings</a>';
...
{ // Installation and uninstallation hooks 
	register_activation_hook(__FILE__, array('WooCommerce_Bootstrap', 'activate')); 
	register_deactivation_hook(__FILE__, array('WooCommerce_Bootstrap', 'deactivate')); 
	
	new WooCommerce_Bootstrap();
}
